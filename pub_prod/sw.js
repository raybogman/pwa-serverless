...
class _private_WorkboxError_WorkboxError extends Error{constructor(e,t){super(h(e,t)),this.name=e,this.details=t}}const u={googleAnalytics:"googleAnalytics",precache:"precache-v2",prefix:"workbox",runtime:"runtime",suffix:"undefined"!=typeof registration?registration.scope:""},l=e=>[u.prefix,e,u.suffix].filter(e=>e&&e.length>0).join("-"),d={updateDetails:e=>{(e=>{for(const t of Object.keys(u))e(t)})(t=>{"string"==typeof e[t]&&(u[t]=e[t])})},getGoogleAnalyticsName:e=>e||l(u.googleAnalytics),getPrecacheName:e=>e||l(u.precache),getPrefix:()=>u.prefix,getRuntimeName:e=>e||l(u.runtime),getSuffix:()=>u.suffix}
...
if(!a)return!1
const{cacheName:o,matchOptions:s}=this._strategy,i=await self.caches.open(o),c=this.hasCallback("cacheDidUpdate"),h=c?await async function cacheMatchIgnoreParams_cacheMatchIgnoreParams(e,t,r,n){const a=cacheMatchIgnoreParams_stripParams(t.url,r)
...
let c
try{c=s.handle({url:r,request:e,event:t,params:a})}catch(e){c=Promise.reject(e)}const h=o&&o.catchHandler
return c instanceof Promise&&(this._catchHandler||h)&&(c=c.catch(async n=>{if(h){0
try{return await h.handle({url:r,request:e,event:t,params:a})}catch(e){n=e}}if(this._catchHandler)return this._catchHandler.handle({url:r,request:e,event:t})
...
const a=await this._ensureResponseSafeToCache(t)
if(!a)return void 0
const{cacheName:o,matchOptions:s}=this._strategy,i=await self.caches.open(o),c=this.hasCallback("cacheDidUpdate"),h=c?await async function _private_cacheMatchIgnoreParams_cacheMatchIgnoreParams(e,t,r,n){const a=_private_cacheMatchIgnoreParams_stripParams(t.url,r)
if(t.url===a)return e.match(t,n)
const o={...n,ignoreSearch:!0},s=await e.keys(t,o)
...
try{await i.put(n,c?a.clone():a)}catch(e){throw"QuotaExceededError"===e.name&&await async function _private_executeQuotaErrorCallbacks_executeQuotaErrorCallbacks(){for(const e of B)await e()}(),e}for(const e of this.iterateCallbacks("cacheDidUpdate"))await e({cacheName:o,oldResponse:h,newResponse:a.clone(),request:n,event:this.event})}async getCacheKey(e,t){if(!this._cacheKeys[t]){let r=e
...
return function isImage(e){return X.test(e.pathname)}(t)&&!isNaN(Z(t))},te=function(){var e=V()($.a.mark(function _callee(e){var t,r,n,a,o,s,i,c,h,u,l,d,p,f,_
...
case 10:o=g.sent,s={difference:1/0,candidate:null},i=!0,c=!1,h=void 0,g.prev=15,u=o[Symbol.iterator]()
case 17:if(i=(l=u.next()).done){g.next=33
...
case 33:g.next=39
break
case 35:g.prev=35,g.t0=g.catch(15),c=!0,h=g.t0
case 39:g.prev=39,g.prev=40,i||null==u.return||u.return()
...
importScripts("https://storage.googleapis.com/workbox-cdn/releases/6.0.2/workbox-sw.js"),function skipWaiting(){self.skipWaiting()}(),function clientsClaim(){self.addEventListener("activate",()=>self.clients.claim())}(),precacheAndRoute([{'revision':null,'url':'/1.3a4fbe696c2a8399dab6.js'},{'revision':null,'url':'/10.27c55acdaad87f749937.js'},{'revision':null,'url':'/11.f15c3d2a3e7e08080caa.js'},{'revision':null,'url':'/12.212a4069f42e25ea74aa.js'},{'revision':null,'url':'/2.e035aea3839128fd38f0.js'},{'revision':null,'url':'/20.d02b6334103573f76140.js'},{'revision':null,'url':'/21.70a8e208e6474cd95a6f.js'},{'revision':null,'url':'/22.6b97682c216ca1950990.js'},{'revision':null,'url':'/23.d68cb95efb5959cd5708.js'},{'revision':null,'url':'/24.95e78cd18d91b5655fd4.js'},{'revision':null,'url':'/25.9022e6e1efd10ce77b36.js'},{'revision':null,'url':'/26.615138757a8d083830c2.js'},{'revision':null,'url':'/27.00c870174ed0c067293a.js'},{'revision':null,'url':'/28.55125fd4aea2e769c33a.js'},{'revision':null,'url':'/29.b4fe8363f8eb4debff22.js'},{'revision':null,'url':'/30.11b2c365c7d66b797f7c.js'},{'revision':null,'url':'/31.3b09622768101830eb51.js'},{'revision':null,'url':'/32.995662716ccddc88a49d.js'},{'revision':null,'url':'/33.b072a7c06a756c795d2c.js'},{'revision':null,'url':'/34.64594b268b9a408ec9b3.js'},{'revision':null,'url':'/35.9af9548256bdf8401ace.js'},{'revision':null,'url':'/36.f74831cf53989ba54f56.js'},{'revision':null,'url':'/37.b9ed00b2285836d00010.js'},{'revision':null,'url':'/38.263cfc72f7d3a5df14b2.js'},{'revision':null,'url':'/39.b48006ca324c44bb17d3.js'},{'revision':null,'url':'/4.da2c535d567be2c9313c.js'},{'revision':null,'url':'/40.6b4d5935c8304d316ad3.js'},{'revision':null,'url':'/41.959458d504d288ada615.js'},{'revision':null,'url':'/42.c2afdc9a7b453145b514.js'},{'revision':null,'url':'/43.a222d1fba4e2d6e0d6a3.js'},{'revision':null,'url':'/44.86ea0cd87ec3308bc211.js'},{'revision':null,'url':'/45.4bc1d6677a9bc407788c.js'},{'revision':null,'url':'/46.8fbf0fee33ca4d16fd0a.js'},{'revision':null,'url':'/47.da417679f6986f264a9c.js'},{'revision':null,'url':'/48.46575bfb684d5d6f2633.js'},{'revision':null,'url':'/49.dfb1acd3f1683505b57a.js'},{'revision':null,'url':'/50.d6ef09fd4339ba607851.js'},{'revision':null,'url':'/51.5745082849dc13283b5b.js'},{'revision':null,'url':'/52.90dade9e65edc13e62df.js'},{'revision':null,'url':'/7.af8ec5d23fbba1204943.js'},{'revision':null,'url':'/8.967d16d0c65c4fccb92b.js'},{'revision':null,'url':'/9.c492abdf4945e597ace1.js'},{'revision':null,'url':'/RootCmp_CMS_PAGE__default.5ea35b072b9bbe6c1838.js'},{'revision':null,'url':'/RootCmp_SEARCH__default.2bb018c5aff622ed3f35.js'},{'revision':'7eb6bd0e0eb5e5b7d61ce557576feaaa','url':'/VeniaLogo-n77.svg'},{'revision':null,'url':'/client.3bedc35f21b0e012612a.js'},{'revision':null,'url':'/i18n-en_US.61df5ef7885668b93d71.js'},{'revision':null,'url':'/runtime.173e73b15f539f75589c.js'},{'revision':null,'url':'/vendors.475cba06cb62f10d0ff7.js'},{'revision':null,'url':'/vendors~RootCmp_CATEGORY__default.f5dd64a339de6defda06.js'},{'revision':null,'url':'/vendors~RootCmp_CATEGORY__default~RootCmp_CMS_PAGE__default.94b50ac370da2e5f4280.js'},{'revision':null,'url':'/vendors~RootCmp_CATEGORY__default~RootCmp_SEARCH__default.4ebbf401abccaf5fe6a2.js'},{'revision':null,'url':'/vendors~RootCmp_PRODUCT__default.9accdea773e54b18c9e5.js'},{'revision':null,'url':'/vendors~acdl.39e06d13b58745cae717.js'}]||[]),Y=function createImageCacheHandler(){return new CacheFirst_CacheFirst({cacheName:"images",plugins:[new ExpirationPlugin_ExpirationPlugin({maxEntries:60,maxAgeSeconds:2592e3}),new CacheableResponsePlugin_CacheableResponsePlugin({statuses:[0,200]})]})}(),registerRoute_registerRoute(new RegExp("(robots.txt|favicon.ico|manifest.json)"),new StaleWhileRevalidate_StaleWhileRevalidate),registerRoute_registerRoute(ee,function(e){var t=e.url,r=e.request,n=e.event,a=te(t,r)
...
try{self["workbox:core:6.1.0"]&&_()}catch(e){}},m0LI:function(e,t){e.exports=function _iterableToArrayLimit(e,t){var r=[],n=!0,a=!1,o=void 0
...
return function invoke(a,o){if(n===u)throw new Error("Generator is already running")
...
if("normal"===p.type){if(n=r.done?l:h,p.arg===d)continue
...
var c="suspendedStart",h="suspendedYield",u="executing",l="completed",d={}
